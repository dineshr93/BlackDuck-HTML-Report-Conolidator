...
/*	public static void main(String[] args) throws IOException {
	...
	public static void performer(String folderinput) throws FileNotFoundException, IOException {
		File BOMFile;
		if(!new File(folderinput).isDirectory()){
		folderinput = pathComponent(folderinput);
		}
		...
		System.out.println("folderinput:"+folderinput);
