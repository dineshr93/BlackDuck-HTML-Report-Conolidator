...
public class TriggerUI extends JPanel implements ActionListener {
    ...
    fc.setFileSelectionMode(JFileChooser.FILES_ONLY);*/
        fc= new JTextArea();
        fc.setText("Rules:\n1. Drag and drop folder which contains only html report\n2. click createDB button.\n3. Wait until popup comes.\n4. Check output in the Output.xlsx file.\nEnd");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        /*	 fc= new JTextArea();
        	...
        	try {
        		...
        		{
        			JOptionPane.showMessageDialog (null, "Please drop single folder containing only BOM html reports", "Info", JOptionPane.INFORMATION_MESSAGE);
        			return;
        		}else
        		BOMDBCreation.performer(FileCellRenderer.files[0]);
        	...
        	//fc.setText("\nCheck output in the Output.xlsx file");
        }
    }
    ...
    private static void createAndShowGUI() {
        ...
        JFrame frame = new JFrame("Bill of materials consolidator");
